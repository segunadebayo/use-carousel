...
var use_previous_1 = __importDefault(require("@rooks/use-previous"));
var auto_id_1 = require("@reach/auto-id");
var rect_1 = require("@reach/rect");
var use_window_size_1 = __importDefault(require("@rooks/use-window-size"));
var react_1 = require("react");
var react_multi_ref_1 = __importDefault(require("react-multi-ref"));
var react_swipeable_1 = require("react-swipeable");
var ssr_window_1 = require("ssr-window");
var utils_1 = require("./utils");
var event_1 = __importDefault(require("@react-hook/event"));
var use_interval_1 = __importDefault(require("@rooks/use-interval"));
/**
...
function useBreakpoints(props) {
    ...
    var windowWidth = use_window_size_1.default().innerWidth;
    var breakPointsRef = react_1.useRef(initialProps);
    if (!breakpoints) {
...
function useCarousel(props) {
     ...
     */
    var _m = react_1.useState(AutoplayStatus.IDLE), status = _m[0], setStatus = _m[1];
     ...
     */
    var isHoveringRef = react_1.useRef(false);
    /**
     * Refs for the slides and slide group
     */
    var slidesRef = react_1.useState(function () { return new react_multi_ref_1.default(); })[0];
    var groupRef = react_1.useRef();
    var _o = react_1.useState(false), isFakeSlide = _o[0], setFakeSlide = _o[1];
    /**
     ...
     */
    var _r = react_1.useState(Math.ceil(slidesRef.map.size / Math.floor(perView))), pages = _r[0], setPages = _r[1];
    /**
     * Update `pages` local state when perView changes due to breakpoint
     */
    utils_1.useUpdateEffect(function () {
     ...
     * so we can
     */
    var prevPerView = use_previous_1.default(Math.floor(perView));
    utils_1.useUpdateEffect(function () {
    ...
    var hasFakeSlides = react_1.useMemo(function () { return loop && perView === 1; }, [loop, perView]);
    /**
     ...
     */
    var rect = rect_1.useRect(groupRef, true);
     ...
     */
    var savedOnReachEnd = utils_1.useLatest(onReachEnd);
    utils_1.useUpdateEffect(function () {
        var _a, _b;
    ...
    var startAutoPlay = react_1.useCallback(function () {
        if (!autoPlayProp || status === AutoplayStatus.TICKING) {
            return;
        }
        setStatus(AutoplayStatus.TICKING);
    }, [autoPlayProp, status]);
    var stopAutoPlay = react_1.useCallback(function () {
        if (!autoPlayProp || status !== AutoplayStatus.TICKING) {
            return;
        }
        setStatus(AutoplayStatus.IDLE);
    }, [autoPlayProp, status]);
    var pauseAutoPlay = react_1.useCallback(function () {
    ...
    use_interval_1.default(increment, interval, autoPlayProp ? status !== AutoplayStatus.TICKING : true);
     ...
     */
    var _s = react_1.useState(0), tempTranslateX = _s[0], setTempTranslateX = _s[1];
    ...
    var swipeableProps = react_swipeable_1.useSwipeable({
    ...
    var onVisibilityChange = function () {
        if (ssr_window_1.document.visibilityState === "hidden" &&
            status === AutoplayStatus.TICKING) {
            pauseAutoPlay();
        }
        if (ssr_window_1.document.visibilityState === "visible" &&
    ...
    event_1.default(window.document, "visibilitychange", onVisibilityChange);
    ...
    return {
        getRootProps: function (props) {
            if (props === void 0) { props = {}; }
            return (__assign(__assign({}, props), { onMouseDown: utils_1.callAllHandlers(props.onMouseDown, swipeableProps.onMouseDown), ref: utils_1.mergeRefs(props.ref, swipeableProps.ref), id: rootId, role: role, "aria-roledescription": "carousel", "aria-labelledby": labelId, style: __assign(__assign({}, props.style), { position: "relative" }) }));
        },
        ...
        getSlideGroupProps: function (props) {
             ...
             */
            var clones = react_1.Children.map(props.children, function (child, idx) {
                var isActive = idx >= index * perView && idx <= (index + 1) * perView;
                return react_1.cloneElement(child, {
                    "data-active": isActive ? "" : undefined,
                    ref: utils_1.mergeRefs(child.ref, slidesRef.ref(idx)),
        ...
        getNextButtonProps: function (props) {
            ...
            return __assign(__assign({}, props), { "aria-controls": slideGroupId, "aria-label": "Next Slide", onClick: utils_1.callAllHandlers(props.onClick, onNextClick), hidden: hidden });
        },
        getPrevButton: function (props) {
            if (props === void 0) { props = {}; }
            var hidden = loop ? false : index === 0;
            return __assign(__assign({}, props), { "aria-controls": slideGroupId, "aria-label": "Previous Slide", onClick: utils_1.callAllHandlers(props.onClick, onPrevClick), hidden: hidden });
        },
        getPauseButtonProps: function (props) {
            ...
            return ({
                ...
                onClick: utils_1.callAllHandlers(props.onClick, pauseAutoPlay),
            });
        },
        ...
        getThumbnailGroupProps: function (props) {
            ...
            var _children = react_1.Children.map(children, function (child, idx) {
                var _a;
                var onTrigger = thumbnailOptions.interaction === "click" ? "onClick" : "onMouseEnter";
                return react_1.cloneElement(child, (_a = {
                        isSelected: idx === index,
                        index: idx
                    },
            ...
            return __assign(__assign({}, rest), { children: _children, tabIndex: 0, onKeyDown: utils_1.callAllHandlers(props.onKeyDown, onKeyDown) });
        },
    };
}
